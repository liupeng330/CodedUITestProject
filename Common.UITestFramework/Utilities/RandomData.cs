...
namespace Common.UITestFramework.Utilities
{
    ...
    public class RandomData
    {
        ...
        public string NextEnglishWordsLowercase(int maxLengthPerWord, int numberOfWord)
        {
            StringBuilder words = new StringBuilder();
            for (int i = 0; i < numberOfWord; i++)
            {
                words.Append(NextEnglishWordLowercase(maxLengthPerWord));
                words.Append(" ");
            }
        ...
        public string NextEnglisthWordUrl(int maxLength)
        {
            string baseUrl = "http://";
            string suffix=".com";
            return baseUrl + NextEnglishWordLowercase(maxLength - baseUrl.Length - suffix.Length) + suffix;
        }
